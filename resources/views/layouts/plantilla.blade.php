										...
										<div class="bestseller-products">
											<div class="big-area grid__item two-thirds">
												<div class="big-product bestseller-product">
													...
													<a class="grid-view-item__link" href="{{route('producto', $best[0]->productid)}}">
											...
											<div class="small-area grid__item one-third">
												<div class="top-product bestseller-product">
													...
													<a class="grid-view-item__link" href="{{route('producto', $best[1]->productid)}}">
                                            ...
                                            <div class="bottom-product bestseller-product">
													...
													<a class="grid-view-item__link" href="{{route('producto', $best[2]->productid)}}">
							...
							<div class="grid grid--uniform grid--view-items ">
                                ...
                                <div class="grid__item small--one-half medium-up--one-quarter one-fifth shuffle-element loadmore_element" >
                                    <div class="grid-view-item">
                                        <div class="grid-normal-display">
                                            <div class="grid__image product-image">
                                                <a class="grid-view-item__link" href="{{route('producto', $random->productid)}}">
                                                    <img class="grid-view-item__image" src="{{asset($random->image_path)}}" alt="Consequuntur magni dolores">
                                                    <img class="hover-image" src="{{asset($random->image_path)}}" alt="{{$random->product}}" title="Consequuntur magni dolores">
                                                </a>
                                        ...
                                        <div class="group-information style-">
                                            {{-- <div class="grid-view-item__vendor">KingStone</div> --}}
                                            <div class="h4 grid-view-item__title"><a href="{{route('producto', $random->productid)}}">{{$random->product}}</a></div>
                                            <div class="price-and-ship">
                                                <div class="grid-view-item__meta grid__item large--three-quarters">
