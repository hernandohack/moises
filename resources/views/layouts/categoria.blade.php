...
<html class="supports-js supports-no-touch supports-csstransforms supports-csstransforms3d supports-fontface supports-pointerevents" lang="en" style="height: 100%;">
  <head>
    ...
    <title>Collection Page - Megastore HTML</title>
...
<body id="megastore-red" class="megastore template-collection" style="position: relative; min-height: 100%; top: 0px;">
								...
								<div class="grid">
									<div class="grid__item one-quarter">
										<a href="./product.html" class="ajaxcart__product-image">
											<img src="{{asset('assets/images/cart1.png')}}" alt="Raesent Scelerisque Dan">
										</a>
									</div>
						...
						<div class="ajaxcart__product">
							<div class="ajaxcart__row" data-line="2">
								<div class="grid">
									<div class="grid__item one-quarter">
										<a href="./product.html" class="ajaxcart__product-image">
											<img src="{{asset('assets/images/cart2.png')}}" alt="Reprehenderit qui in ea">
										</a>
									</div>
									<div class="grid__item three-quarters">
										<div class="ajaxcart__product-name--wrapper">
						...
						<div class="ajaxcart__product">
							<div class="ajaxcart__row" data-line="3">
								<div class="grid">
									<div class="grid__item one-quarter">
										<a href="./product.html" class="ajaxcart__product-image">
											<img src="{{asset('assets/images/cart3.png')}}" alt="Etiam lobortis purus dictum">
										</a>
									</div>
									<div class="grid__item three-quarters">
										<div class="ajaxcart__product-name--wrapper">
						...
						<div class="ajaxcart__product">
							<div class="ajaxcart__row" data-line="4">
								<div class="grid">
									<div class="grid__item one-quarter">
										<a href="./product.html" class="ajaxcart__product-image">
											<img src="{{asset('assets/images/cart4.png')}}" alt="Raesent Scelerisque Dan">
										</a>
									</div>
									<div class="grid__item three-quarters">
										<div class="ajaxcart__product-name--wrapper">
					...
					<div class="wrapper">
						<div class="left-area">
							<div class="site-nav__item nav-language medium-down--hide">
								<div class="switcher notranslate">
									<div class="selected lang-switcher">
										<a href="./index.html"><img src="{{asset('assets/images/en.png')}}" height="16" width="16" alt="en"> English</a>
									</div>
									<div class="option">
										<a href="./index.html" title="English" class="lang-sub selected"><img src="{{asset('assets/images/en.png')}}" height="16" width="16" alt="en"> English</a>
										<a href="./index.html" title="French" class="lang-sub"><img src="{{asset('assets/images/fr.png')}}" height="16" width="16" alt="fr"> French</a>
										<a href="./index.html" title="German" class="lang-sub"><img src="{{asset('assets/images/de.png')}}" height="16" width="16" alt="de"> German</a>
										<a href="./index.html" title="Italian" class="lang-sub"><img src="{{asset('assets/images/it.png')}}" height="16" width="16" alt="it"> Italian</a>
										<a href="./index.html" title="Russian" class="lang-sub"><img src="{{asset('assets/images/ru.png')}}" height="16" width="16" alt="ru"> Russian</a>
										<a href="./index.html" title="Spanish" class="lang-sub"><img src="{{asset('assets/images/es.png')}}" height="16" width="16" alt="es"> Spanish</a>
									</div>
								</div>
							</div>
							<div class="site-nav__item nav-currency medium-down--hide">
							    <div class="switcher notranslate">
									<div class="selected currency-switcher">
										<a href="./index.html"><img src="{{asset('assets/images/usd.png')}}" height="16" width="16" alt="en"> US Dollar</a>
									</div>
									<div class="option">
										<a href="./index.html" title="English" class="curr-sub selected"><img src="{{asset('assets/images/usd.png')}}" height="16" width="16" alt="en"> USD</a>
										<a href="./index.html" title="French" class="curr-sub"><img src="{{asset('assets/images/euro.png')}}" height="16" width="16" alt="en"> Euro</a>
										<a href="./index.html" title="German" class="curr-sub"><img src="{{asset('assets/images/pound.png')}}" height="16" width="16" alt="en"> Pound</a>
										<a href="./index.html" title="Italian" class="curr-sub"><img src="{{asset('assets/images/yen.png')}}" height="16" width="16" alt="en"> Yen</a>
									</div>
								</div>
							</div>
							...
							<div id="AppModal" class="mfp-hide" style="max-width: 500px;margin: 0 auto;">
								<div class="ios-area">
									<div class="qrimg-ios">
										<a href="#"><img src="{{asset('assets/images/QR_Code_Tadatheme.png')}}" alt=""></a>
									</div>
									<div class="qropt-ios"><img src="{{asset('assets/images/apple-store.png')}}" alt=""></div>
								</div>
								<div class="ios-area">
									<div class="qrimg-android">
										<a href="#"><img src="{{asset('assets/images/QR_Code_Megastore.png')}}" alt="Image Column"></a>
									</div>
									<div class="qropt-android"><img src="{{asset('assets/images/google-play.png')}}" alt=""></div>
								</div>
								...
								<div class="grid__item large--show medium-down--hide smal--hide">
									<div class="wrapper-middle">
										...
										<div class="grid__item large--three-tenths logo-wrapper">
											<a href="./index.html" itemprop="url" class="site-header__logo-image">
												<img src="{{asset('assets/images/logo.png')}}" alt="">
											</a>
										</div>
										...
										<li class="site-nav__item site-nav--has-dropdown dropdown megamenu-vertical megacol-3 dropdown-long" aria-haspopup="true">
											<p class="site-nav__link">
												<span class="site-nav__icon icon-1">
													  <img src="{{asset('assets/images/cocktail-dress.png')}}" alt="">
													</span>
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product1.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												<li class="column-2 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product2.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
										...
										<li class="site-nav__item site-nav--has-dropdown dropdown megamenu-vertical megacol-3 dropdown-long" aria-haspopup="true">
											<p class="site-nav__link">
												<span class="site-nav__icon icon-2">
													  <img src="{{asset('assets/images/cotton-polo-shirt.png')}}" alt="">
													</span>
												...
												<li class="column-1 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product4.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												<li class="column-2 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product5.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												<li class="column-3 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product6.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												...
												<li class="column-1 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product7.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												<li class="column-2 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product8.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												...
												<li class="column-3 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product9.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												...
												<li class="column-1 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product10.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												<li class="column-2 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product11.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												<li class="column-3 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product12.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												...
												<li class="column-1 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product13.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												<li class="column-2 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product14.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												<li class="column-3 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product15.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												...
												<li class="column-1 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product16.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												<li class="column-2 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product17.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												<li class="column-3 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html"><img src="{{asset('assets/images/product18.png')}}" alt=""></a>
															</div>
														</div>
													</div>
												</li>
												...
												<li class="column-1 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product19.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-2 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product20.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-2 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product3.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-3 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product4.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-1 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product5.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-3 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product7.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-1 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product8.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-2 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product9.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-3 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product10.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-1 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product11.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-2 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product12.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-3 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product13.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-1 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product14.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-2 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product15.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
												...
												<li class="column-3 grid__item one-third">
													...
													<div class="row-3">
														<div class="box-border">
															...
															<div class="site-nav__banner">
																<a href="./product.html">
																	<img src="{{asset('assets/images/product16.png')}}" alt="">
																</a>
															</div>
														</div>
													</div>
														...
														<div class="grid-normal-display">
															<div class="grid__image product-image">
																<a class="grid-view-item__link" href="./product.html">
																	<img class="grid-view-item__image" src="{{asset('assets/images/product1.png')}}" alt="Consequuntur magni dolores">
																	<img class="hover-image" src="{{asset('assets/images/product1x.png')}}" alt="Consequuntur magni dolores" title="Consequuntur magni dolores">
																</a>
														...
														<div class="group-information style-">
															...
															<div class="price-and-ship">
																...
																<div class="shipcode grid__item large--one-quarter">
																	<img src="{{asset('assets/images/freeshipicon.svg')}}" alt="free shipping icon" />
																</div>
															</div>
												...
												<li class="mobile-nav__item column-product grid__item small--one-whole medium-up--one-third one-fifth">
													<div class="grid-view-item">
														<div class="grid-normal-display">
															<div class="grid__image product-image">
																<a class="grid-view-item__link" href="./product.html">
																	<img class="grid-view-item__image" src="{{asset('assets/images/product3.png')}}" alt="Consequuntur magni dolores">
																	<img class="hover-image" src="{{asset('assets/images/product3x.png')}}" alt="Consequuntur magni dolores" title="Consequuntur magni dolores">
																</a>
															</div>
															<div class="quickbuy">
																<div class="product-ajax-quickbuy in-stock hidden-xs hidden-sm">
												...
												<li class="mobile-nav__item column-product grid__item small--one-whole medium-up--one-third one-fifth">
													<div class="grid-view-item">
														<div class="grid-normal-display">
															<div class="grid__image product-image">
																<a class="grid-view-item__link" href="./product.html">
																	<img class="grid-view-item__image" src="{{asset('assets/images/product4.png')}}" alt="Consequuntur magni dolores">
																	<img class="hover-image" src="{{asset('assets/images/product4x.png')}}" alt="Consequuntur magni dolores" title="Consequuntur magni dolores">
																</a>
																<div class="product-label">
																	<div class="label-element deal-label">
																		<span style="color:#ff5722; background-color: #ffd839;">20% off</span>
												...
												<li class="mobile-nav__item column-product grid__item small--one-whole medium-up--one-third one-fifth">
													<div class="grid-view-item">
														<div class="grid-normal-display">
															<div class="grid__image product-image">
																<a class="grid-view-item__link" href="./product.html">
																	<img class="grid-view-item__image" src="{{asset('assets/images/product2.png')}}" alt="Consequuntur magni dolores">
																	<img class="hover-image" src="{{asset('assets/images/product2x.png')}}" alt="Consequuntur magni dolores" title="Consequuntur magni dolores">
																</a>
															</div>
															<div class="quickbuy">
																<div class="product-ajax-quickbuy in-stock hidden-xs hidden-sm">
												...
												<li class="mobile-nav__item column-product grid__item small--one-whole medium-up--one-third one-fifth">
													<div class="grid-view-item">
														<div class="grid-normal-display">
															<div class="grid__image product-image">
																<a class="grid-view-item__link" href="./product.html">
																	<img class="grid-view-item__image" src="{{asset('assets/images/product5.png')}}" alt="Consequuntur magni dolores">
																	<img class="hover-image" src="{{asset('assets/images/product5x.png')}}" alt="Consequuntur magni dolores" title="Consequuntur magni dolores">
																</a>
															</div>
															<div class="quickbuy">
																<div class="product-ajax-quickbuy in-stock hidden-xs hidden-sm">
							...
							<div class="grid--rev collayout-left" id="collection">
								<div class="grid__item large--three-quarters">
									<section class="section-image">
										<img src="{{asset('assets/images/banner-cate.png')}}" alt="">
										...
										<div class="categorias" >
                                            @foreach ($subcategorias as $sub )
                                                    <a href="./collection.html">
                                                        <img src="{{asset('assets/images/categorias_scales.jpg')}}" alt="">
                                                    </a>
                                            @endforeach
                                        </div>
									</section>
